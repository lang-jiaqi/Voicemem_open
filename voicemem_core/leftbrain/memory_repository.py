...
from voicemem_core.leftbrain.cognitive_graph import (
    CognitiveAnnotator,
...
class LeftBrainMemoryRepository:
    ...
    def __init__(
        ...
        *,
        ...
        self._vector_store = Mem0BackendStore(embedder, memory_root=root)
        ...
        *,
        ...
        def _right():
            if self._experience_repo is None:
                from voicemem_core.rightbrain.types import RightBrainContext, CurrentSignals
...
def create_openai_memory_repository(
    *,
    ...
    """
    from voicemem_core.leftbrain.cognitive_graph import CognitiveAnnotatorConfig as _CogCfg
