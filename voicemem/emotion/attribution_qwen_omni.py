...
from voicemem.emotion.types import TurnAttributionLLMResult, TurnEmotionRecord
from voicemem.emotion.omni_generate import (
    build_omni_text_gen_kwargs,
    suppress_omni_text_inference_noise,
)
from voicemem.emotion.vad_qwen_prompt import _get_sequences
    ...
    def analyze_turn_with_audio(
        ...
        *,
        ...
        if self.result is not None:
            return self.result
        from voicemem.emotion.types import EmotionGraphDelta, EmotionGraphNodeInput, EmotionSignal
