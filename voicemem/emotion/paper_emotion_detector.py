...
from voicemem.emotion.layer import EmotionLayerConfig
...
class PaperAlignedEmotionDetector:
    ...
    def _ensure_attributor(self):
        ...
        try:
            ...
            print(f"  [emotion] Qwen-Omni 归因器加载失败，退回纯声学 VAD 粗分类: {e}", flush=True)
    ...
    def detect(self, audio_path: Path) -> str:
        ...
        try:
            ...
            from voicemem.emotion.types import TurnEmotionRecord
